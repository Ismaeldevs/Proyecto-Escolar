...
return (
    <div className="contenedor-juego-vivo">
        ...
        {fase === 'final' && (
            // Contenedor principal de la pantalla final
            // CLASE CORREGIDA para centrar todo el contenido
            <div className="maestro-final-container">
                
                {/* Título Principal */}
                <div className="maestro-resumen-tarjeta">
                    <h1>🏆 ¡Juego Terminado!</h1>
                    <p>Resultados finales del quiz.</p>
                </div>

                {/* Tarjeta de Ranking */}
                <div className="maestro-ranking-lista">
                    <h3>🏅 Ranking Final</h3>
                    
                    {rankingFinal.map((jugador, index) => (
                        <div 
                            key={index} 
                            // Resaltamos al ganador con la clase top-winner
                            className={`maestro-ranking-item ${index === 0 ? 'top-winner' : ''}`}
                        >
                ...
                {/* Botones de Acción */}
                {/* CLASE AÑADIDA para centrar horizontalmente los botones */}
                <div className="maestro-final-buttons-wrapper">
                    <button 
                        onClick={reiniciarJuego} 
                        className="maestro-btn-finalizar maestro-btn-reinicio"
                    >
                        🔄 Jugar de Nuevo
                    </button>
                    ...
                    <button 
                        ...
                        className="maestro-btn-finalizar"
                    >
