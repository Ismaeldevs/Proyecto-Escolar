  ...
  return (
    <>
      ...
      <div className="canciones-page">
        ...
        <div className="canciones-header-row">
          <h1 className="canciones-titulo">🎵 Canciones Infantiles</h1>
          <img 
            src="./imagenmascota/seccioncancionesmascota.png" 
            alt="Mascota Canciones" 
            className="canciones-mascota-img" 
          />
        </div>
